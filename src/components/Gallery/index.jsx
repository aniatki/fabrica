    ...
    return (
        <div id="projetos" className='col-span-full md:col-span-8 px-2 md:px-0 md:col-start-2 mt-32 grid grid-cols-8 gap-4 max-w-full mx-auto'>
            ...
            <img
                ...
                intersect-once intersect:motion-preset-expand motion-duration-500 motion-delay-500
                ' />
            ...
            <img
                ...
                intersect-once intersect:motion-preset-expand motion-duration-500 motion-delay-750
                ' />
            ...
            <img
                ...
                intersect-once intersect:motion-preset-expand motion-duration-500 motion-delay-1000
                ' />
            ...
            <video
                ...
                intersect-once intersect:motion-preset-expand motion-duration-500 motion-delay-1250
                '
            >
            </video>
            ...
            <video
                ...
                intersect-once intersect:motion-preset-expand motion-duration-500 motion-delay-1500
                '
            >
            </video>
            ...
            <img
                ...
                intersect-once intersect:motion-preset-expand motion-duration-500 motion-delay-1750
                ' />
            ...
            <img
                ...
                intersect-once intersect:motion-preset-expand motion-duration-500 motion-delay-2000
                ' />
        </div>
    )
}